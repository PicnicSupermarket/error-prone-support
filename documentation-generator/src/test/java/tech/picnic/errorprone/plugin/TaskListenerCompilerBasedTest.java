...
abstract class TaskListenerCompilerBasedTest {
  public void compile(String outputDirectory, String... lines) {
    compile(outputDirectory, Kind.ANALYZE, lines);
  }

  public void compile(String outputDirectory, Kind taskEventKind, String... lines) {
    performCompilationForFile(
        outputDirectory,
        taskEventKind,
        FileObjects.forSourceLines("TaskListenerTestInput.java", lines));
  }

  private static void performCompilationForFile(
      String outputDirectory, Kind taskEventKind, JavaFileObject javaFileObject) {
    ...
    TaskEvent taskEvent = new TaskEvent(taskEventKind, compilationUnitTree, classSymbol);
