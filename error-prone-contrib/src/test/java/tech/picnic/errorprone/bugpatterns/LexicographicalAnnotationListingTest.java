  ...
  void identification() {
    CompilationTestHelper.newInstance(LexicographicalAnnotationListing.class, getClass())
        .addSourceLines(
            ...
            "  class UnsortedClass {",
            "    // BUG: Diagnostic contains:",
            "    @Foo @Bar private final int unsortedField;",
            "",
            "    // BUG: Diagnostic contains:",
            "    @Foo",
            "    @Bar",
            "    // BUG: Diagnostic contains:",
            "    UnsortedClass(@FooTypeUse @BarTypeUse int unsortedParam) {",
            "      this.unsortedField = unsortedParam;",
            "    }",
            "  }",
            "}")
        .doTest();
  ...
  void replacement() {
    BugCheckerRefactoringTestHelper.newInstance(LexicographicalAnnotationListing.class, getClass())
        ...
        .addOutputLines(
            ...
            "  @Foo",
            "  class UnsortedClass {",
            "    @Bar @Foo private final int unsortedField;",
            "",
            "    @Bar",
            "    @Foo",
            "    UnsortedClass(@BarTypeUse @FooTypeUse int unsortedParam) {",
            "      this.unsortedField = unsortedParam;",
            "    }",
            "  }",
            "}")
