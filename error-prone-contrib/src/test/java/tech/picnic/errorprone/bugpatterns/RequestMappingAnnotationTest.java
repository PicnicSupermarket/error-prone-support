  ...
  void identification() {
    CompilationTestHelper.newInstance(RequestMappingAnnotation.class, getClass())
        .addSourceLines(
            ...
            "",
            "  @GetMapping",
            "  A properModelAttribute(@ModelAttribute String attribute);",
            "",
            "  @GetMapping",
            ...
            "",
            "  @RequestMapping",
            "  A properPrincipal(Principal principal);",
            "",
            "  @RequestMapping",
            "  A properAuthentication(Authentication authentication);",
            "",
            "  @RequestMapping",
            "  A properAuthenticationToken(UsernamePasswordAuthenticationToken authentication);",
            "",
            "  @RequestMapping",
