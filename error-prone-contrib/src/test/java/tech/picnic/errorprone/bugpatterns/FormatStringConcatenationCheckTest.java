  ...
  void identification() {
    compilationTestHelper
        .addSourceLines(
            ...
            "    assertThat(0).overridingErrorMessage(\"str %s\", 0);",
  ...
  void replacement() {
    refactoringTestHelper
        .addInputLines(
            ...
            "    assertThat(0).overridingErrorMessage(\"str \" + (toString() + \" word \") + (1 + 1));",
            "",
        ...
        .addOutputLines(
            ...
            "    assertThat(0).overridingErrorMessage(\"str %s word %s\", toString(), 1 + 1);",
            "",
            "    // Flagged but not auto-fixed.",
            "    assertThat(0).overridingErrorMessage(\"%s \" + toString(), \"arg\");",
            "  }",
