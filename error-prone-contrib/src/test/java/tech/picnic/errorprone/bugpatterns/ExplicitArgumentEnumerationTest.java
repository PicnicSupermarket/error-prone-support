  ...
  void identification() {
    CompilationTestHelper.newInstance(ExplicitArgumentEnumeration.class, getClass())
        .addSourceLines(
            ...
            "    unaryMethodWithExtendsWildcardIncompatibleVarargsOverload(ImmutableList.of(1, 2));",
            "    unaryMethodWithSuperWildcardIncompatibleVarargsOverload(ImmutableList.of(1, 2));",
            "    unaryMethodWithUnboundWildcardIncompatibleVarargsOverload(ImmutableList.of(1, 2));",
            "    // BUG: Diagnostic contains:",
            ...
            "  }",
            "",
            "  private int unaryMethodWithExtendsWildcardIncompatibleVarargsOverload(",
            "      ImmutableList<? extends Number> args) {",
            "    return 0;",
            "  }",
            "",
            "  private int unaryMethodWithExtendsWildcardIncompatibleVarargsOverload(Integer... args) {",
            "    return unaryMethodWithExtendsWildcardIncompatibleVarargsOverload(ImmutableList.copyOf(args));",
            "  }",
            "",
            "  private int unaryMethodWithSuperWildcardIncompatibleVarargsOverload(",
            "      ImmutableList<? super Integer> args) {",
            "    return 0;",
            "  }",
            "",
            "  private int unaryMethodWithSuperWildcardIncompatibleVarargsOverload(Integer... args) {",
            "    return unaryMethodWithSuperWildcardIncompatibleVarargsOverload(ImmutableList.copyOf(args));",
            "  }",
            "",
            "  private int unaryMethodWithUnboundWildcardIncompatibleVarargsOverload(ImmutableList<?> args) {",
            "    return 0;",
            "  }",
            "",
            "  private int unaryMethodWithUnboundWildcardIncompatibleVarargsOverload(Integer... args) {",
            "    return unaryMethodWithUnboundWildcardIncompatibleVarargsOverload(ImmutableList.copyOf(args));",
            "  }",
            "",
