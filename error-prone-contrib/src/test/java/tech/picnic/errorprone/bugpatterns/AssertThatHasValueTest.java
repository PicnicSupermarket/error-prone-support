  ...
  void identification() {
    CompilationTestHelper.newInstance(AssertThatHasValue.class, getClass())
        .addSourceLines(
            ...
            "",
            "    var assertion = assertThat(Optional.of(6).orElseThrow());",
            "    assertion.isEqualTo(7);",
            "",
            "    assertThat(Optional.of(8).orElseThrow(IllegalStateException::new)).isEqualTo(9);",
            "    assertThat(Optional.of(10).orElseThrow(IllegalStateException::new)).isSameAs(11);",
            "",
            "    // BUG: Diagnostic contains:",
            "    assertThat(Optional.of(12).orElseThrow()).isEqualTo(13);",
            "    // BUG: Diagnostic contains:",
            "    assertThat(Optional.of(\"foo\").orElseThrow()).isEqualTo(\"bar\");",
            "    // BUG: Diagnostic contains:",
            "    assertThat(Optional.<Number>of(14).orElseThrow()).isEqualTo(15);",
            "    // BUG: Diagnostic contains:",
            "    assertThat(Optional.of(16).orElseThrow()).isSameAs(17);",
            "    // BUG: Diagnostic contains:",
