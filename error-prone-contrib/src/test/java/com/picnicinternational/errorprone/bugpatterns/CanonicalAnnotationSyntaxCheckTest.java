    ...
    public void testIdentification() {
        compilationTestHelper
                .addSourceLines(
                        ...
                        "",
                        "  // BUG: Diagnostic contains:",
                        "  @pkg.A.Foo({1}) Object singleton1();",
                        "  // BUG: Diagnostic contains:",
                        "  @A.Foo({1}) Object singleton2();",
                        "  // BUG: Diagnostic contains:",
                        "  @Foo({1}) Object singleton3();",
                        "",
                        "  // BUG: Diagnostic contains:",
                        ...
                        "",
                        "  // BUG: Diagnostic contains:",
                        "  @pkg.A.Foo(value2 = {2}) Object customSingleton1();",
                        "  // BUG: Diagnostic contains:",
                        "  @A.Foo(value2 = {2}) Object customSingleton2();",
                        "  // BUG: Diagnostic contains:",
                        "  @Foo(value2 = {2}) Object customSingleton3();",
                        "",
                        "  @pkg.A.Foo(value2 = {2, 2}) Object customPair1();",
                        "  @A.Foo(value2 = {2, 2}) Object customPair2();",
                        "  @Foo(value2 = {2, 2}) Object customPair3();",
                        "",
    ...
    public void testReplacement() throws IOException {
        refactoringTestHelper
                .addInputLines(
                        ...
                        "  @Foo(value = 1) Object verbose3();",
                        "",
                        "  @pkg.A.Foo(value = {1}) Object moreVerbose1();",
                        "  @A.Foo(value = {1}) Object moreVerbose2();",
                        "  @Foo(value = {1}) Object moreVerbose3();",
                        "",
                        "  @pkg.A.Foo(value = {1, 1}, value2 = {2}) Object extended1();",
                        "  @A.Foo(value = {1, 1}, value2 = {2}) Object extended2();",
                        "  @Foo(value = {1, 1}, value2 = {2}) Object extended3();",
                        "}")
                .addOutputLines(
                        "out/pkg/A.java",
                        "package pkg;",
                        ...
                        "",
                        "  @pkg.A.Foo(1) Object moreVerbose1();",
                        "  @A.Foo(1) Object moreVerbose2();",
                        "  @Foo(1) Object moreVerbose3();",
                        "",
                        "  @pkg.A.Foo(value = {1, 1}, value2 = 2) Object extended1();",
                        "  @A.Foo(value = {1, 1}, value2 = 2) Object extended2();",
                        "  @Foo(value = {1, 1}, value2 = 2) Object extended3();",
