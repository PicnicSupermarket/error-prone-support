...
final class BigDecimalRulesTest implements RefasterRuleCollectionTestCase {
  ...
  ImmutableSet<BigDecimal> testBigDecimalTwo() {
    return ImmutableSet.of(BigDecimal.valueOf(2), BigDecimal.valueOf(2L), new BigDecimal("2"));
  }
  ...
  ImmutableSet<Boolean> testBigDecimalSignumEqualToOne() {
    return ImmutableSet.of(
        BigDecimal.valueOf(1).compareTo(BigDecimal.ZERO) > 0,
        BigDecimal.ZERO.compareTo(BigDecimal.valueOf(2)) < 0,
  ...
  ImmutableSet<Boolean> testBigDecimalSignumEqualToNegativeOne() {
    return ImmutableSet.of(
        BigDecimal.valueOf(1).compareTo(BigDecimal.ZERO) < 0,
        BigDecimal.ZERO.compareTo(BigDecimal.valueOf(2)) > 0,
        BigDecimal.valueOf(3).signum() < 0,
