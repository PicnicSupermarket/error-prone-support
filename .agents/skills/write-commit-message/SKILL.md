...
description: >
  Use this skill when writing or suggesting a commit message for changes in
  this repository.
---
...
2. **Write** the commit message following those conventions.
3. **Review** it against the applicable sections of
