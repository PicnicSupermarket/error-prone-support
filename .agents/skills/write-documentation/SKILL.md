...
description: >
  Use this skill when creating or modifying Markdown documentation, instruction
  files, or skill files in this repository.
---

# Write Documentation

Use this skill for requests to add or change `.md` files.

* Read [`.github/instructions/documentation.instructions.md`][documentation]
  for the writing conventions.
* When editing instruction files, also read
